...
knowledge0 = And(
    # There is one character, A

    # Either A is a knight or a knave, not both
    Or(AKnight, AKnave),
...
knowledge1 = And(
    ...
    # Either A or B is a knight or a knave, not both at the same time
    Or(AKnight, AKnave),
    Not(And(AKnave, AKnight)),
    Or(BKnight, BKnave),
...
knowledge3 = And(
    ...
    # Any character is either a knight or a knave, not both at the same time
    Or(AKnight, AKnave),
    Not(And(AKnave, AKnight)),
    Or(BKnight, BKnave),
    Not(And(BKnight, BKnave)),
